...
const messages = {
  en: { home: "Home", criminalList: "Criminal List", uploadDoc: "Upload Doc", logOut: "Log out", language: "Language", search: "Search", close: "Close", clearSelection: "Clear selection", aiInsight: "AI insight", lastSeen: "Last seen", recordsOnFile: "Records on file", tracedConnections: "Traced connections", linksKnown: "Links between known associates", crimeFrequency: "Crime tag frequency", citiesWatch: "Cities under watch", pinned: "Currently Pinned", noWorking: "Not working on anyone currently", caseHistory: "Case history", crimesCommitted: "Crimes committed", status: "Status", familyKnown: "Family known", dateBirth: "Date of birth", height: "Height", investigatorWorkspace: "Investigator workspace", networkAnalysis: "Network analysis", addToAnalysis: "Add to Investigator Analysis", connections: "Connections", aiInvestigator: "AI investigator", investigatorAnalysis: "Investigator analysis", askAI: "Ask AI", age: "Age", closeFile: "Close file", addToList: "Add to list", removeFromList: "Remove from list", loading: "Loading…", loadingRecords: "Loading records…", noRecords: "No records found in the database.", noSearchMatches: "No case file matches that search.", searchResults: "files matched", criminalsOnFile: "criminals on file", basedIn: "based in", uploadAnalyze: "Upload and analyze records", recordSource: "Record source", uploadingFile: "Uploading file", uploadTooLarge: "larger than 20 MB", uploadFailedSome: "could not be uploaded:", databaseHint: "Rows are read as data and staged for your review — statements in the file are never run. For PostgreSQL export plain SQL: pg_dump --format=plain --data-only --inserts. SQLite, CSV and JSON exports are also accepted.", upload: "Upload", noDocuments: "No documents uploaded yet.", openOriginal: "Open original document", review: "Review", closeDocument: "Close", reset: "Reset", retry: "Retry", fit: "Fit", selectedPerson: "Selected person", zoomIn: "Zoom in", zoomOut: "Zoom out", map: "Map", network: "Network", openFile: "Open file", unpin: "Unpin", onTheList: "On the list", noCases: "No cases added yet", tracked: "Criminals currently tracked" },
  hi: { home: "होम", criminalList: "अपराधी सूची", uploadDoc: "दस्तावेज़ अपलोड करें", logOut: "लॉग आउट", language: "भाषा", search: "खोजें", close: "बंद करें", clearSelection: "चयन हटाएं", aiInsight: "एआई जानकारी", lastSeen: "अंतिम बार देखा गया", recordsOnFile: "रिकॉर्ड", tracedConnections: "ट्रेस किए गए संबंध", linksKnown: "ज्ञात सहयोगियों के बीच संबंध", crimeFrequency: "अपराध टैग आवृत्ति", citiesWatch: "निगरानी वाले शहर", pinned: "वर्तमान में पिन किए गए", noWorking: "अभी किसी पर काम नहीं हो रहा", caseHistory: "मामले का इतिहास", crimesCommitted: "किए गए अपराध", status: "स्थिति", familyKnown: "ज्ञात परिवार", dateBirth: "जन्म तिथि", height: "कद", investigatorWorkspace: "जांचकर्ता कार्यक्षेत्र", networkAnalysis: "नेटवर्क विश्लेषण", addToAnalysis: "जांचकर्ता विश्लेषण में जोड़ें", connections: "संबंध", aiInvestigator: "एआई जांचकर्ता", investigatorAnalysis: "जांचकर्ता विश्लेषण", askAI: "एआई से पूछें", age: "आयु", closeFile: "फाइल बंद करें", addToList: "सूची में जोड़ें", removeFromList: "सूची से हटाएं", loading: "लोड हो रहा है…", loadingRecords: "रिकॉर्ड लोड हो रहे हैं…", noRecords: "डेटाबेस में कोई रिकॉर्ड नहीं मिला।", noSearchMatches: "इस खोज से कोई केस फाइल नहीं मिली।", searchResults: "फाइलें मिलीं", criminalsOnFile: "अपराधी रिकॉर्ड", basedIn: "स्थान", uploadAnalyze: "रिकॉर्ड अपलोड और विश्लेषण करें", recordSource: "रिकॉर्ड स्रोत", uploadingFile: "फ़ाइल अपलोड हो रही है", uploadTooLarge: "20 एमबी से बड़ी है", uploadFailedSome: "अपलोड नहीं हो सकीं:", databaseHint: "पंक्तियाँ केवल डेटा के रूप में पढ़ी जाती हैं और आपकी समीक्षा के लिए रखी जाती हैं — फ़ाइल के स्टेटमेंट कभी नहीं चलाए जाते। पोस्टग्रेएसक्यूएल के लिए सादा एसक्यूएल निर्यात करें: pg_dump --format=plain --data-only --inserts। एसक्यूलाइट, सीएसवी और जेसन निर्यात भी स्वीकार्य हैं।", upload: "अपलोड", noDocuments: "अभी कोई दस्तावेज़ अपलोड नहीं है।", openOriginal: "मूल दस्तावेज़ खोलें", review: "समीक्षा", closeDocument: "दस्तावेज़ बंद करें", reset: "रीसेट", retry: "पुनः प्रयास", fit: "फिट", selectedPerson: "चयनित व्यक्ति", zoomIn: "ज़ूम इन", zoomOut: "ज़ूम आउट", map: "मानचित्र", network: "नेटवर्क", openFile: "फाइल खोलें", unpin: "पिन हटाएं", onTheList: "सूची में", noCases: "अभी कोई केस नहीं जोड़ा गया", tracked: "वर्तमान में ट्रैक किए गए अपराधी" },
};
Object.assign(messages.en, {
  ...
  analysisSelect: "Add a person, then ask about the whole network or select a node or relationship.", analysisWholeNetwork: "Whole network", analysisWholeNetworkHint: "Asking about the whole network. Select a node or relationship to focus on one record.",
...
Object.assign(messages.hi, {
  ...
  analysisSelect: "पहले कोई व्यक्ति जोड़ें, फिर पूरे नेटवर्क के बारे में पूछें या कोई नोड/संबंध चुनें।", analysisWholeNetwork: "पूरा नेटवर्क", analysisWholeNetworkHint: "पूरे नेटवर्क के बारे में पूछा जा रहा है। किसी एक रिकॉर्ड पर ध्यान देने के लिए नोड या संबंध चुनें।",
